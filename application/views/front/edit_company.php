            ...
            <div class="row">
                <div class="col-md-12">
                    <ul class="nav navbar-nav navbar-left">
                        <li><a href="<?= $link_url?>mi-grupo"><?= lang("Info General")?></a></li>
                        <li><a href="<?= $link_url?>editar-grupo" class="active"><?= lang("Editar")?></a></li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <div class="container main-content">
        <div class="col-md-12">
            <div class="panel panel-primary">
                <form class="ajax-form" id="edit-company-form" method="post" action="<?= $link_url.'home/validate_contact_form/edit_company'?>" enctype="multipart/form-data">
                    <div class="panel-body">
                        <div class="col-md-12 col-sm-12">
                            <div class="row" id="profile-info">
                                <div id="contact_success" class="alert alert-success" style="display: none"></div>
                                <div class="col-md-12"><h1><small><?= $this->company_model->namespace?>.prode2018.com</small></h1></div>
                                <div class="clearfix"></div>
                                <?
                                $this->admin_forms->label_in_input = false;
                                foreach($page_fields['edit_company'] as $field => $attr)
                                {

                                    echo '<div class="form-group contact" id="'.$field.'_box">
												'.$this->admin_forms->input_block($field,$attr, $this->company_model->$field).'
												<div class="clearfix"></div>

		...
		<div class="col-md-offset-2 col-md-8">
             <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    <div class="row">
                    	<div class="col-md-12" align="center" id="first-time-header"><h4><?= lang("COMPLETA TUS DATOS")?></h4>
                        <small><?= lang("Para finalizar el registro")?></small>	
						
                        <div class="alert alert-danger" id="error" style="display:none"></div>
                        </div>
                    	<div class="col-md-12" id="first-time-content">
                            <form method="POST" class="form-signin ajax_form" action="<?=$link_url.'home/validate_contact_form/first_login'?>" accept-charset="UTF-8">
                               <?
                            $this->admin_forms->label_in_input = false;
                            foreach($page_fields['first_login'] as $field => $attr)
                            {

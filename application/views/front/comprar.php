...
<div class="container">
    <div class="row">
        ...
        <h1 align="center">Compra y empezá a Jugar Ahora!</h1>
        <a mp-mode="dftl" href="https://www.mercadopago.com/mla/checkout/start?pref_id=35681194-e6b2cdd6-9ef4-4615-8154-fab5c469b6a7" name="MP-payButton" class='green-ar-m-rn-none'>Comprar PRODE para 10 personas $300</a>
<script type="text/javascript">
(function(){function $MPC_load(){window.$MPC_loaded !== true && (function(){var s = document.createElement("script");s.type = "text/javascript";s.async = true;s.src = document.location.protocol+"//secure.mlstatic.com/mptools/render.js";var x = document.getElementsByTagName('script')[0];x.parentNode.insertBefore(s, x);window.$MPC_loaded = true;})();}window.$MPC_loaded !== true ? (window.attachEvent ?window.attachEvent('onload', $MPC_load) : window.addEventListener('load', $MPC_load, false)) : null;})();
</script>
        <br />
        <a mp-mode="dftl" href="https://www.mercadopago.com/mla/checkout/start?pref_id=35681194-5f8722b2-dc37-4ea6-8216-4e0e0b56760a" name="MP-payButton" class='green-ar-m-rn-none'>Comprar PRODE para 20 personas $500 </a>
<script type="text/javascript">
(function(){function $MPC_load(){window.$MPC_loaded !== true && (function(){var s = document.createElement("script");s.type = "text/javascript";s.async = true;s.src = document.location.protocol+"//secure.mlstatic.com/mptools/render.js";var x = document.getElementsByTagName('script')[0];x.parentNode.insertBefore(s, x);window.$MPC_loaded = true;})();}window.$MPC_loaded !== true ? (window.attachEvent ?window.attachEvent('onload', $MPC_load) : window.addEventListener('load', $MPC_load, false)) : null;})();
</script>
        <br /><br />
        <p align="center">Pagá con MercadoPago <img src="https://http2.mlstatic.com/ui/navigation/2.3.2/mercadopago/logo__large.png" border="0" /></p>
        </div>
    </div>
    <div class="row">
        ...
        <div class="wow bounceIn <?= $this->company_model->register ? "comprar-col-demo  col-md-offset-1 col-md-7" : "comprar-col-demo col-md-8 col-sm-offset-2 col-sm-7"?>" data-wow-delay="1.5s">

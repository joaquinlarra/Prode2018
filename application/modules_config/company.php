...
$config['modules'][$module_name]['fields'] = array(	
										...
										'points_match' => array(	'label' => 'Puntos por partido',
															...
															'validation' => '',
															'value' => '3',
															'description' => "Número. Valor sugerido 3",
															'visibility' => 'save|details'
															),
										'points_exact_match' => array(	'label' => 'Puntos por partido Exacto',
															'type' => 'text',
															'value' => '5',
															'validation' => '',
															'description' => "Número. Valor sugerido 5",
															'visibility' => 'save|details'
															),
										...
										'patriot_seller'=> array(	'label' => 'Vende patria',
															...
															'value' => 1,
															'validation' => '',
															'description' => "Se incluirá el badge vendepatria",
															'visibility' => 'save|details'
															),
										'super_patriot'=> array('label' => 'Super Patriota',
															'type' => 'checkbox',
															'value' => 1,
															'validation' => '',

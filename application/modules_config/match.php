...
$config['modules'][$module_name]['fields'] = array(
										...
										*/
										...
										'zone' => array( 'label' => 'Grupo / Zona',
													...
													'options' => array(
																		...
																		8 => array("value" => "Octavos", "label" => "8vos"),
																		9 => array("value" => "Cuartos", "label" => "4tos"),
																		10 => array("value" => "Semifinal", "label" => "SemiFinal"),
																		11 => array("value" => "Final", "label" => "Final"),
																		12 => array("value" => "3er_y_4to", "label" => "3er y 4to")
																		),
										...
										/*
                                        'tournament_date' => array( 'label' => 'Fecha (torneo)',
													'type' => 'text',
										...
										*/
										...
										'team1_goals' => array(	'label' => 'Goles 1',
															'type' => 'text',
															'class' => 'number',
															'validation' => '',
															'visibility' => 'save|details|list'
													),
										'team2_goals' => array(	'label' => 'Goles 2',
															'type' => 'text',
															'class' => 'number',
															'validation' => '',
															'visibility' => 'save|details|list'
										...
										'result' => array(	'label' => 'Resultado',
															...
															'options' => array( 0 => array("value" => "-2","label" => "Por Jugar"),
																			    1 => array("value" => "-1","label" => "Ganó 1"),
																				2 => array("value" => "0","label" => "Empate"),
																				3 => array("value" => "1","label" => "Ganó 2"),
																				),
															'validation' => '',
															'value' => '-2',
															'visibility' => 'save|details|list'
